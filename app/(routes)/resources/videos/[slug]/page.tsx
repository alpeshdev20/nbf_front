...
//* Icons
import ResourceTypeIcon from "@/images/categories/video-card-icon.png";
        ...
        {!isLoading && resourceInfo !== null && (
          <div className="resource-info-section">
            <div className="app-container">
              ...
              {/* Episodes */}
              <ResourceEpisodes resourceId={slug ?? ""} />
...
const VideoInfo = ({ params }: { params: { slug: string } }) => {
  return (
    <Suspense>
